...
public class SamayaPervayaActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    NavigationView navigatsiyaView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_samaya_pervaya);
        ...
        navigatsiyaView = findViewById(R.id.nav_view);
        navigatsiyaView.setNavigationItemSelectedListener(this);
    ...
    protected void onResume() {
        ...
        changeNavbarNickName(navigatsiyaView, newRab.name);
        changeNavbarResizedImage(navigatsiyaView);
    ...
    private void changeNavbarResizedImage(NavigationView navigationView) {
        ...
        if (circularImageView.getDrawable() != null) {
            AllSomeImgs.loadImageFromStorage(getApplicationContext(), circularImageView, newRab.id);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(this, PravilaUsloviyaActivity.class);
    ...
    public boolean onNavigationItemSelected(@NotNull MenuItem item) {
        ...
        if (id == R.id.nav_messages) {
            ...
            Intent intent = new Intent(this, StranichkaActivity.class);
            ...
            DialogFragment dialog = new FeedNazadPageKoFragment();
            dialog.show(getSupportFragmentManager(), "Feedback");

        } else if (id == R.id.nav_sign_out) {
            Intent intent = new Intent(this, CheTamStartingActivity.class);
            startActivity(intent);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == Activity.RESULT_OK) {
                assert data != null;
                newRab = (Employee) data.getSerializableExtra("newEmployee");
            }
        }
    }
}
